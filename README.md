...
- **UI 视觉大升级**：采用全新的玻璃拟态设计，引入骨架屏加载动画与丝滑交互动效
- **Obsidian 深度集成**：支持一键导出 Markdown 并保存至 Obsidian，补全图片本地化能力
- **订阅源管理极简高效**：支持鼠标拖拽自由排序，新增批量管理与文章全文搜索
- **同步进度可视化**：实时反馈公众号更新状态，批量同步进度与结果一目了然
- **阅读体验智能优化**：内置正文 HTML 自动清理与排版引擎，还原最清爽的阅读感受
- **同步策略科学优化**：优化连续更新延迟策略，默认间隔 3s，平衡效率与封控风险
- v2.x版本使用全新接口，更加稳定
- 获取公众号历史发布文章
- 后台自动定时更新内容
